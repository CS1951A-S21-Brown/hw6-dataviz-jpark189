...
df_action = df_action[["Genre", "Publisher", "Global_Sales"]]
...
df_adventure.reset_index(inplace=True)
df_adventure = df_adventure[["Genre", "Publisher", "Global_Sales"]]
...
df_fighting.reset_index(inplace=True)
df_fighting = df_fighting[["Genre", "Publisher", "Global_Sales"]]
...
df_misc = df_misc[["Genre", "Publisher", "Global_Sales"]]
...
df_platform = df_platform[["Genre", "Publisher", "Global_Sales"]]
...
df_puzzle.reset_index(inplace=True)
df_puzzle = df_puzzle[["Genre", "Publisher", "Global_Sales"]]
...
df_racing.reset_index(inplace=True)
df_racing = df_racing[["Genre", "Publisher", "Global_Sales"]]
...
df_role_playing.reset_index(inplace=True)
df_role_playing = df_role_playing[["Genre", "Publisher", "Global_Sales"]]
...
df_shooter.reset_index(inplace=True)
df_shooter = df_shooter[["Genre", "Publisher", "Global_Sales"]]
...
df_simulation = df_simulation[["Genre", "Publisher", "Global_Sales"]]
...
df_sports.reset_index(inplace=True)
df_sports = df_sports[["Genre", "Publisher", "Global_Sales"]]
...
df_strategy.reset_index(inplace=True)
df_strategy = df_strategy[["Genre", "Publisher", "Global_Sales"]]
# df_strategy.to_csv("./data/video_games_q3_strategy.csv")

df_combined = pd.concat([df_action, df_adventure, df_fighting, df_misc, df_platform, df_puzzle, df_racing, df_role_playing, df_shooter, df_simulation, df_sports, df_strategy])
df_combined.to_csv("./data/video_games_q3_combined.csv")
